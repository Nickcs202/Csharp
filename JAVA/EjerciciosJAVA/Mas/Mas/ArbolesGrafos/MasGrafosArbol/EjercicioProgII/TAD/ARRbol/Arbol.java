...
public class Arbol {
    ...
    public void insercionRecursiva(Object dato){
        ...
        if (raiz == null){
            ...
            insertarInt(nuevoNodo, raiz);
        }
    }

    private void insertarInt(NodoArbol nuevoNodo, NodoArbol actual){
        if ((Integer)nuevoNodo.getDato() <= (Integer) actual.getDato()){
            if (actual.getIzq() == null){
                actual.setIzq(nuevoNodo);
            }else {
                insertarInt(nuevoNodo, actual.getIzq());
            }
        }else {
            if (actual.getDer() == null){
                actual.setDer(nuevoNodo);
            }else {
                insertarInt(nuevoNodo, actual.getDer());
            }
        }
    }
